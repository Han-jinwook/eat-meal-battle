...
| family_groups      | id                | uuid                        | NO          |
| family_groups      | owner_id          | uuid                        | NO          |
| family_groups      | name              | character varying           | NO          |
| family_groups      | family_photo      | text                        | YES         |
| family_groups      | created_at        | timestamp with time zone    | YES         |
| family_members     | id                | uuid                        | NO          |
| family_members     | family_id         | uuid                        | NO          |
| family_members     | user_id           | uuid                        | NO          |
| family_members     | role              | character varying           | NO          |
| family_members     | joined_at         | timestamp with time zone    | YES         |
...
| 관계                                                        | 설명                        |
| ----------------------------------------------------------- | --------------------------- |
| `family_groups.owner_id` → `users.id`                       | 가족 그룹의 방장(owner)     |
| `family_members.family_id` → `family_groups.id`             | 가족 그룹 소속              |
| `family_members.user_id` → `users.id`                       | 가족 구성원 유저            |
...
> **참고**: 본 문서는 `스키마.md` (v1.4, 2026-07-03) 기반으로 신규 스키마를 반영하여 업데이트되었습니다. (v1.5, 2026-07-31)
