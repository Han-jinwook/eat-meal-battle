              ...
              {noMenu ? (
                ...
                <>
                  ...
                  >
                    <svg width="280" height="60" viewBox="0 0 280 60" role="img" aria-label="퀴즈 생성 버튼">
                      <defs>
                        <linearGradient id="quizGenGradStatic2" x1="0%" y1="0%" x2="100%" y2="0%">
                          <stop offset="0%" stopColor="#6A00FF"/>
                          <stop offset="50%" stopColor="#3F55FF"/>
                          <stop offset="100%" stopColor="#00D1FF"/>
                        </linearGradient>
                        <filter id="quizGenShadowStatic2" x="-20%" y="-20%" width="140%" height="160%">
                          <feDropShadow dx="0" dy="6" stdDeviation="8" floodColor="#0A1B2B" floodOpacity="0.18"/>
                        </filter>
                      </defs>
                      
                      {/* Button shape */}
                      <rect x="3" y="3" rx="12" ry="12" width="274" height="54" fill="url(#quizGenGradStatic2)" filter="url(#quizGenShadowStatic2)"/>
