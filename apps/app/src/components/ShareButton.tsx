    ...
    <>
      <div className={`my-4 flex justify-end ${className}`}>
        <button
          onClick={handleShare}
          disabled={isSharing}
          className={`w-full px-4 py-4 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-lg font-semibold hover:from-purple-600 hover:to-purple-700 transition-all duration-200 shadow-lg flex items-center justify-center gap-3 ${isSharing ? 'opacity-70 cursor-not-allowed' : ''}`}
        >
