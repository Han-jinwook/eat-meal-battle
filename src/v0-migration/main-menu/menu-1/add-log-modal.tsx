            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="relative group cursor-pointer aspect-video w-full rounded-xl border-2 border-dashed border-gray-200 bg-white flex flex-col items-center justify-center gap-2 hover:border-primary/50 hover:bg-orange-50/30 transition-all overflow-hidden">
                <div className="flex flex-col items-center gap-2">
                  <Camera className="size-8 text-muted-foreground/50 group-hover:text-primary transition-colors" />
            ...
            {mealType === "집밥" && (
              <div className="flex flex-col gap-3">
                ...
                {recipeInputType === "url" ? (
                  ...
                  <textarea
                    className="w-full px-4 py-3.5 bg-white border-2 border-gray-100 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all text-sm text-foreground placeholder:text-muted-foreground/50 resize-none"
