          ...
          >
            {/* 샘플 리본 */}
             {(meal.id === 1 || meal.id === 2 || meal.id === 3) && (
               <div className="absolute top-3.5 -right-12.5 w-48 bg-yellow-400 text-yellow-900 text-[10px] font-black py-1 text-center rotate-45 shadow-md z-10 pointer-events-none">
                 💡 SAMPLE
               </div>
             )}
            {/* Card Content */}
